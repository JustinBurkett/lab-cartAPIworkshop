...
namespace BuckeyeMarketplace.Data.Migrations
{
    ...
    [Migration("20260415010356_UpdateOrderPlacementContract")]
    partial class UpdateOrderPlacementContract
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuckeyeMarketplace.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BuckeyeMarketplace.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BuckeyeMarketplace.Models.CartItem", b =>
                {
                    b.HasOne("BuckeyeMarketplace.Models.Cart", "Cart")
                        .WithMany("Items")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BuckeyeMarketplace.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BuckeyeMarketplace.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
